// packages/components/src/observation/ObservationCard.tsx
import React from "react";
import Image from "next/image";
import { format } from "date-fns";
import { Card, CardContent, CardHeader, CardTitle } from "@kuroshio-lab/ui";
import { Button } from "@kuroshio-lab/ui";
import { Badge } from "@kuroshio-lab/ui";
import { cn } from "@kuroshio-lab/styles";

// These types and utilities should be provided by the consuming app
...
function formatDepth(min?: number | null, max?: number | null): string {
  ...
  if (max === null || max === undefined) return `${min}m`;
  return `${min}-${max}m`;
}
